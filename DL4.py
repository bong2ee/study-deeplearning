'''
    ...
    2. 인공지능 역사
        ...
        3) 학습의 시대
            ...
            - 의료분야, 진단
            - 언어검색(자연어 처리)
            - 경영 분야(빅데이터 -> 인공지능 -> 경명의아결정)
            - 딥러닝 예술(화품 모방)
            - 음악

    3. 신경망
        1) 인공 신경망(artifical neural network: ANN)
            - 생물학적인 신경망에서 영감을 받아서 만들어진 컴퓨터 구조
                - 인간의 뇌 구조 모방
            - 장점
    ...
    4. 퍼셉트론(perceptron)
        1) 생물학적 뉴런을 모방하여 만든 인공신경망의 기본단위
