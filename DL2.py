'''
    ...
    2. Artificial Intelligence(인공 지능) 
        1) 인간의 학습 능력 추론, 지각 능력을 인공적으로 구현한 것
        ...
        - 머신러닝을 공학적으로 세 가지 중요한 요소가 필요함
            - 해결해야 할 문제(작업) T
            - 성능 척도를 통해 평가할 수 있어야 함
            - 지속적인 훈련 경험 E
        
        - 인공 신경망을 이용해 딥러닝(Deep learning) 분야 역시 이 머신러닝의 한 분야로 볼 수 있음
        ...
        2) 회귀분석
            ...
            - 주택의 면적이 큰 경우 판매가격도 높은 경우가 많음
                ...
                - 관측된 데이터를 바탕으로 다차원 공간에 존재하는 데이터들을 가장 잘 설명하는 수학 함수를 찾는 것 
                    ...
                    - 이 둘 사이 상관관계가 1차 방정식으로 표현될 수 있는 선형관계라고 함
                        - 주택 면적 x와 거래가격 y의 관계는 y= wx + b로 표현됨
                        - 기울기 w와 절편 b를 어떻게 정의하는가에 따라 표현할 수 있음
